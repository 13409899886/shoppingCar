  ...
  <div class="c-p-form">
            ...
            <div class="weui-cell weui-cell_select weui-cell_select-after">
                <div class="weui-cell__hd">
                    <label for="" class="weui-label">任务类别：</label>
                </div>
	        ...
	        <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input" type="text" pattern="[0-9]*" placeholder="请输入任务名称"/>
                </div>
            </div>
        </div>
        ...
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <textarea class="weui-textarea" placeholder="请输入任务详情" rows="3"></textarea>
...
<style scoped>
		.weui-btn,.weui-switch-cp__input:checked~.weui-switch-cp__box{background: -webkit-linear-gradient(top,#ffa515,#ff7e3d);border: 1px solid #fca120}
</style>
