<template>
  <div style="padding-bottom: 80px;">
    ...
    <div class="weui-panel weui-panel_access">
    	<div class="weui-panel__hd">我的广场 <router-link :to="{path:''}" tag="a" class="more">more</router-link></div>
        <div class="weui-panel__bd">
            <router-link :to="{path:'/squareDetails/2'}" class="weui-media-box weui-media-box_appmsg">
...
<style scoped>
	...
	.fabu{position: fixed; right: 15px; top: 40%; width: 60px; height: 60px; text-align: center;line-height: 60px; border-radius: 50%;background:linear-gradient(top,#ffa515,#ff7e3d); color:#fff;}
</style>
